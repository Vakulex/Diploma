...
public class PlayerMovementState : IState
{
    ...
    private void Move()
    {
        ...
        Vector3 targetRotationDirection = GetTargetRotation(targetRotationYAngle);
    ...
    protected void SetBaseRotationData()
    {
        ...
        stateMachine.ReusableData.TimeToReachRotation = stateMachine.ReusableData.RotationData.TargetRotationReachTime;
    }
    ...
    protected void RotateTowardsTargetRotation()
    {
        ...
        float smoothYAngle = Mathf.SmoothDampAngle(currentYAngle,
            ...
            stateMachine.ReusableData.TimeToReachRotation.y - stateMachine.ReusableData.DampedTargetRotationPassedTime.y);
    ...
    protected void DecelerateHorizontally()
    {
        ...
        stateMachine.Player.Rigidbody.AddForce(-playerHorizontalVelocity * stateMachine.ReusableData.MovementDecelerationForce,
    ...
    protected void DecelerateVertically()
    {
        ...
        stateMachine.Player.Rigidbody.AddForce(-playerVerticalVelocity * stateMachine.ReusableData.MovementDecelerationForce,
            ForceMode.Acceleration);
    }
    ...
    protected bool IsMovingUp(float minVelocity = 0f)
    {
        return GetPlayerVerticalVelocity().y > minVelocity;
    }
    
    protected bool IsMovingDown(float minVelocity = 0f)
    {
        return GetPlayerVerticalVelocity().y < -minVelocity;
    }
    ...
    protected void EnableCameraRecentering(float waitTime = -1f, float recenteringTime = -1f)
    {
        ...
        stateMachine.Player.CameraRecentringUtility.EnableRecentering(waitTime, recenteringTime, movementData.BaseSpeed, movementSpeed);
    }
    
    protected void DisableCameraRecentering()
    {
        stateMachine.Player.CameraRecentringUtility.DisableRecentering();
    }
    
    protected void SetBaseCameraRecentringData()
    {
